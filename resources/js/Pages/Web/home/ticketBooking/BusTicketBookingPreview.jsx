        ...
        <div className="rounded-[10px] border border-gray-200 overflow-hidden bg-white">
            ...
            <div className="px-4 pb-4 border-t border-gray-100 pt-3">
                ...
                {selected.length === 0 ? (
                    ...
                    <p className="mt-2 text-gray-800 font-[700] text-sm">
                    ...
                    <div className="lg:col-span-1">
                        <div className="rounded-[10px] border border-gray-200 bg-gray-50">
                            <div className="px-5 py-6 border-b border-gray-200 rounded-t-[10px] bg-[#0955AC]">
                                <h2 className="text-xl font-[700] text-[#FFFFFF]">{t("passenger_details", "Passenger Details")}</h2>
                            </div>
                            ...
                            <form onSubmit={onSubmit} className="px-5 py-4 space-y-4">
                                {isRoundTrip && (
                                    <div className="space-y-2 pb-2 border-b border-gray-200">
                                        <div className="flex items-center justify-between text-sm">
                                            ...
                                            <span className="font-semibold text-gray-800">{formatPrice(outboundTotal)}</span>
                                        </div>
                                        <div className="flex items-center justify-between text-sm">
                                            <span className="text-gray-600">Return ({returnSelected.length} seats)</span>
                                            <span className="font-semibold text-gray-800">{formatPrice(returnTotal)}</span>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-[#0955AC] text-xl font-bold">{formatPrice(total)}</span>
                                </div>

                                <div className="text-[#0955AC]">
                                    <label className="mb-1 block text-sm font-[600] text-[#0955AC]">{t("passenger_name", "Passenger Name")}</label>
                                    <input
                                        type="text"
                                        value={passengerName}
                                ...
                                <div className="text-[#0955AC]">
                                    <label className="mb-1 block text-sm font-[600] text-[#0955AC]">{t("mobile_number", "Mobile Number")}</label>
                                    <input
                                        type="tel"
                                        value={mobile}
                                ...
                                <div className="text-[#0955AC]">
                                    <label className="mb-1 block text-sm font-[600] text-[#0955AC]">{t("boarding_place", "Boarding Place")}</label>
                                    <select
                                        value={boarding}
                                ...
                                <div className="text-[#0955AC]">
                                    <label className="mb-1 block text-sm font-[600] text-[#0955AC]">{t("dropoff_place", "Drop-off Place")}</label>
                                    <select
                                        value={destination}
                                        onChange={(e) => setDestination(e.target.value)}
                                        className="w-full rounded-[10px] border px-3 py-4 border-[#0955AC] focus:ring-[#0955AC]"
                                    >
                                        <option value="">Select your drop-off point</option>
                            ...
                            <ul className="space-y-3">
                                {legend.map((l) => (
                                    <li key={l.label} className="flex items-center gap-3">
                                        <span className={`inline-block h-6 w-6 rounded ${l.swatch}`} />
