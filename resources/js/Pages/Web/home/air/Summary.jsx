...
import QuoteModal from "../../components/AirVehicleDetails/QuoteModal"; // adjust path if different
...
const Summary = () => {
  ...
  // DONE → go to /multiModel/plan-journey?subTab=air&tab=rental
  const handleDone = () => {
    router.visit("/multiModel/plan-journey?subTab=air&tab=rental", {
      method: "get",
      preserveScroll: true,
    });
  };
