...
const Payments = () => {
  ...
  const handleConfirmBooking = () => {
    ...
    router.post(
      route("client.seaBookings.confirm", booking.id),
  ...
  const handlePaymentBooking = () => {
    router.visit(route("client.seaBookings.payments", booking?.id), {
      method: "get",
      preserveScroll: true,
    });
  };
  ...
  const toggleAddon = async (name) => {
    ...
    try {
      setToggling(true);
      const { data } = await axios.patch(route("client.bookings.updateAirVehicleAddons", booking.id), {
        addons: payload,
      });
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-row items-start justify-center pb-10">
            <div className="md:flex flex-col hidden justify-center items-center gap-3 cursor-pointer" onClick={handleVehicleList}>
              ...
              <h1 className="figtree text-[16px] font-[700] text-[#0955AC]">Select Sea Vehicle</h1>
            </div>
              ...
              <div className="mt-4 rounded-[10px] bg-[#F1F5F9] px-5 py-4 flex flex-col gap-2">
                ...
                {walletError && (
                  <div className="flex items-center gap-2 text-red-600 text-[12px] font-[600]">
                    ...
                    <a href={route("client.wallet.dashboard")} className="ml-1 underline text-[#0955AC]">
                      Top up now
                    </a>
                  </div>
                )}
