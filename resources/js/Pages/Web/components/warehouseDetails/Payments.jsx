...
const WarehousePayments = () => {
    ...
    const handleConfirmBooking = async () => {
        ...
        const formattedData = {
            ...
            storage_unit: updatedBookingData.storage_unit || 'sqft',
            ...
            quantity: updatedBookingData.quantity || null,
            estimated_weight: updatedBookingData.estimated_weight || updatedBookingData.estimatedWeight || null,
            special_handling_required: Boolean(updatedBookingData.special_handling_required),
            ...
            delivery_pickup_required: Boolean(updatedBookingData.delivery_pickup_required),
            delivery_pickup_address: updatedBookingData.delivery_pickup_address || null,
            monthly_rate: monthlyRate,
            security_deposit: securityDeposit,
            setup_fee: setupFee,
            add_ons_cost: addOnsCost,
